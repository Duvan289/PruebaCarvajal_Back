...
4. Configurar la ruta de conexion a la base de datos, hago referencia al servidor, que en la mayoria de los casos es localhost. Esta ruta se enceuntra en el archivo appsettings.json.
